...
import it.polito.policytoollib.policy.resolution.impl.ComposedResolutionStrategy;
...
public class ComposedPolicy implements Policy{
	...
	public Policy getFMRPolicy() {
		return fmrPolicy;
	}
	
	public void setFMRPolicy(Policy fmrPolicy) {
		this.fmrPolicy = fmrPolicy;
	}
	...
	public void setCan(CanonicalForm can) {
		this.can = can;
	}
	...
	public void setSL(Semilattice<GenericRule> sl) {
		this.sl = sl;
	}
	...
	@Override
	public <S> void insertRuleNoCheck(GenericRule rule, S externalData) throws OperationNotPermittedException {
		throw new OperationNotPermittedException("Not allowed for Canonical Form Instance");
