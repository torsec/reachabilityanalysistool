...
public class ApacheOrderDenyAllowResolutionStrategy extends ResolutionStrategy {

	private static final String label = "Apache Order Allow";
	...
	public ResolutionStrategy cloneResolutionStrategy() {
		return new ApacheOrderDenyAllowResolutionStrategy();
	}
