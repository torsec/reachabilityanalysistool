...
public class PortSelector extends TotalOrderedSelectorImpl {
	...
	private int [] r_copy;
	private List<Long> l;
	private static Integer minPort = 0;
	private static Integer maxPort = 65535;
	private static String selName="Port Number";
	...
	public String toSinglePortString() {
		if(this.isEmpty())
			return "";
		for(int port : ranges)
			if(port>-1)
