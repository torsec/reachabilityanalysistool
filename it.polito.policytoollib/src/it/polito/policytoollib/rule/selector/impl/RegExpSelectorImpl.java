...
public abstract class RegExpSelectorImpl implements RegExpSelector {
	...
	protected static String selName = "Regular Expression";
	//private static RegExpSelectorFactory factory=RegExpSelectorFactory.getInstance();
...
//		RegExpSelector r = new RegExpSelector();
...
//		return "-i "+OtherOperations.toRegExp(automata.clone());
//	}
...
//else automata = BasicOperations.union(automata,regexp.toAutomaton());
//automata.determinize();
//this.regexp = regexp;
//}
//
