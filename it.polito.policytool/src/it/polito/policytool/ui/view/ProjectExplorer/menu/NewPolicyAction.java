...
import it.polito.policytool.ui.wizard.NewPolicy.NewPolicyWizard;
...
public class NewPolicyAction implements IAction {
	
	private PolicyType policyType;

	public NewPolicyAction(PolicyType policyType) {
	...
	public void runWithEvent(Event event) {
		 WizardDialog wizardDialog = new WizardDialog(PlatformUI.getWorkbench().getDisplay().getActiveShell().getShell(),
			      new NewPolicyWizard(policyType));
