...
public class AnalyzePolicyAction implements IAction {
	
	private Policy policy;
	
	public AnalyzePolicyAction(Policy policy){
		this.policy = policy;
	}
	...
	public void runWithEvent(Event event) {
		PolicyToolUIModel.getInstance().getAnomalyAnalyzerResultView().setInput(PolicyToolUIModel.getInstance().getSingleAnomalies(policy.getName()),policy.getName(),null);
		try {
